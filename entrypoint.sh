...
mkdir /v2raybin
cd /v2raybin
wget --no-check-certificate -qO 'v2ray.zip' "https://github.com/v2fly/v2ray-core/releases/download/$V_VER/v2ray-linux-$SYS_Bit.zip"
...
wget --no-check-certificate -qO 'demo.tar.gz' "https://github.com/kr1s-gzq/v2ray-heroku-undone/raw/master/demo.tar.gz"
tar xvf demo.tar.gz
rm -rf demo.tar.gz
